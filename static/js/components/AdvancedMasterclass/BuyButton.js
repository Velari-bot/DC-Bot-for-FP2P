...
/**
 * Advanced Masterclass Buy Button
 * Triggers Stripe checkout for the Advanced Masterclass
 */
const BuyButton = ({ text, billingCycle = 'month', className }) => {
    ...
    const handleBuy = async (e) => {
        ...
        try {
            ...
            const response = await checkout(mw, false, email, COURSE_IDS.ADVANCED, { billingCycle });
    ...
    const defaultClass = "inline-block bg-gradient-to-r from-[#ff0000] to-red-600 text-black font-bold text-lg md:text-xl px-8 md:px-16 py-5 rounded-full hover:from-red-600 hover:to-[#ff0000] transition-all shadow-[0_0_30px_rgba(255,0,0,0.5)] hover:shadow-[0_0_40px_rgba(255,0,0,0.7)] disabled:opacity-50 disabled:cursor-not-allowed";
