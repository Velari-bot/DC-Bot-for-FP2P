...
const PastClients = () => {
    return (
        <section className="-mt-10 md:-mt-[148px] py-12 md:pt-32 md:pb-72 px-4 relative z-10 bg-[linear-gradient(to_bottom,transparent,rgba(0,0,0,0.25)_20%,rgba(0,0,0,0.25)_80%,transparent)]">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex justify-center items-start gap-10 md:gap-16 flex-wrap">
