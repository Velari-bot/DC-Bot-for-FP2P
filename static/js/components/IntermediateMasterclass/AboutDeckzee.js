            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
                    ...
                    <div className="relative mb-8 lg:mb-0" data-aos="fade-right">
                        <div className="absolute inset-0 bg-[#ff7800]/20 blur-3xl rounded-full" />
                        <img
                    ...
                    <div className="order-1 lg:order-2 text-center lg:text-left flex flex-col justify-center" data-aos="fade-left">
                        ...
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                            Learn from a Pro with <span className="text-[var(--orange)]">5 years of experience</span>
                        </h2>
                        ...
                        <div className="max-w-xl mx-auto lg:mx-0 text-left">
                            ...
                            <div className="space-y-3 md:space-y-4 mb-10 ml-4">
                                {placements.map((placement, index) => (
                                    ...
                                    >
                                        <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#ff7800]/20 flex items-center justify-center mt-0.5">
                                            <TrophyIcon className="text-[var(--orange)]" size={16} />
                                        </div>
                                        <div>
